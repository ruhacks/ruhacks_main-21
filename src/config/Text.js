export const infoBoxTitles = {
    ...
    FAQ: {
        ...
        howWillIGet: 'How will I get to RU Hacks?',
        cost: 'How much does it cost to attend RU Hacks?',
        firstTime: 'I’ve never attended a hackathon before...',
...
export const infoBoxDescription = {
    AboutAnswers:{
        whatIs: 'RU Hacks is a unique hackathon at Ryerson University, located at the heart of downtown Toronto. This year will be our fourth RU Hacks and we hope you will be here to join us for 36 hours of creativity. Meet new people, learn new skills and have fun while showcasing your talents.',
    ...
    FAQAnswers:{
        whoCanAttend: 'If you are a student enrolled in any undergraduate or graduate program and are 18 or older, you are eligible to apply and attend RU Hacks.',
